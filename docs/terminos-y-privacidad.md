...
| Versiones | Que los términos pueden cambiar y cómo se avisa; el alta guarda la versión aceptada | [3. Modelo de datos, APP_USER](03-modelo-de-datos.md#app_user) |
