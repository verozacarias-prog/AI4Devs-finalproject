...
- **Tarjetas de crédito**: la tarjeta es una cuenta con cierre y vencimiento; cada compra, en uno o varios pagos, pesa en el presupuesto del mes en que vence cada cuota, y pagar el resumen es una transferencia. El fundamento está en el [ADR 0012](adr/0012-tarjetas-de-credito-y-transferencias.md).
