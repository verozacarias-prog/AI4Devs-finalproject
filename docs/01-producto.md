...
- **Transferencias entre cuentas propias**: sacar efectivo, pasar plata de un banco a una billetera o comprar dólares mueve saldos sin contar como gasto ni ingreso. Detalle en [reglas de dominio § 13](reglas-de-dominio.md#13-tarjetas-de-crédito-y-transferencias).
